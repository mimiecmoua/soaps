    ...
    return (
        <nav className="navbar navbar-expand-lg bg-body-tertiary bg-white py-3 shadow-sm">
            <div className="container">
                ...
                <img src={`${process.env.PUBLIC_URL}/assets/logo1.png`} alt="" height="50px" width="50px" />
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className="buttons">
                        ...
                        <NavLink to="/register" className="btn btn-outline-dark ms-2"><i className="fa fa-user-plus me-1"></i> Inscription</NavLink>
                        <NavLink to="/cart" className="btn btn-outline-dark ms-2"><i className="fa fa-shopping-cart me-1"></i> Panier ({cartItems.length})</NavLink>
                    </div>
                </div>
            </div>
        </nav>
